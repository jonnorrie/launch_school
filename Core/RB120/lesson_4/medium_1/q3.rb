...
# This change allows the instance variable to be changed directly, rather than being changed through the `update_quantity`. This means the test if the amount is above 0 can be circumvented