...
# The object returned is a different string entirely, due to the use of the #split method, which returns an array. when we call #join on the array, we are creating a new string from the contents of the array