...
iterate through array
  for each element in array, iterate through array again
    compare element from first iteration to element from second iteration.
    if elements are the same, increase counter by 1
      if counter == 2
        reassign duplicate variable to current element
